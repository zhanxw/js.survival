...
function allGroupsKm(groups) {
    ...
    var tte = Array.prototype.concat.apply([], _.pluck(groups, 'tte')),
     ev = Array.prototype.concat.apply([], _.pluck(groups, 'ev'));
    // var tte = [].concat.apply([], _.pluck(groups, 'tte'))pluck(groups, 'tte');
    // var ev = pluck(groups, 'ev');
...
exports.logranktest  = logranktest;